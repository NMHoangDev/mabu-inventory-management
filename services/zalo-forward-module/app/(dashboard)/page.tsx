/**
 * Trang duy nhất của module — port từ
 * app/(dashboard)/zalo/forward-rules/page.tsx của app chính. SSR chỉ để xác
 * định role hiển thị nút tạo/sửa/xoá — enforcement thật nằm ở API route.
 */
...
export default async function ForwardRulesPage() {
  ...
  return <ForwardRulesDashboard role={role} />;
}
