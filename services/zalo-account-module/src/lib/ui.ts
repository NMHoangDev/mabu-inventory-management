 ...
 * webapp merkeeai (xem COLOR_SYSTEM_GUIDE.md của app đó).
 *
 * Vì sao gom vào 1 file: cùng 1 kiểu nút/input/thẻ/pill xuất hiện ở 4-5 trang,
 * viết tay mỗi nơi thì sớm muộn cũng lệch nhau. App gốc cũng làm y vậy.
 *
...
export const btn = {
  ...
  /** Cảnh báo — dùng cho "Kết nối lại" khi tài khoản mất kết nối. */
