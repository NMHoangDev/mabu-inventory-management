 ...
 * học theo trang auth của webapp merkeeai.
 */

import { Suspense, useEffect, useState } from "react";
import { useRouter, useSearchParams } from "next/navigation";
import { AlertTriangle, Check, Loader2, Lock, LogIn, Mail, MessageCircle, ShieldCheck } from "lucide-react";
...
const HIGHLIGHTS = [
  "Quản lý nhiều tài khoản Zalo ở một nơi",
  "Nhắn tin & nhận tin ngay trong trang",
  "Admin cấp quyền theo từng Gmail"
];
      ...
      <div className="flex w-full flex-col justify-center px-6 py-10 lg:w-1/2 lg:px-16">
        <div className="mx-auto w-full max-w-sm space-y-6">
          <div>
            ...
            <p className="mt-1.5 text-sm text-slate-500">Quản lý Zalo tập trung — InvoiceFlow Manager</p>
          </div>
      ...
      <div className="hidden border-l border-slate-200 bg-slate-50 lg:flex lg:w-1/2 lg:flex-col lg:justify-center lg:px-16">
        <div className="max-w-md">
          ...
          <h2 className="mt-5 text-2xl font-bold tracking-tight text-slate-900">
            Trung tâm điều khiển Zalo cho cả đội
          </h2>
          <p className="mt-2 text-sm leading-relaxed text-slate-600">
            Kết nối tài khoản Zalo, nhắn tin với khách và phân quyền cho từng nhân viên — tất cả trong một
            trang, không cần mở Zalo Web.
          </p>
