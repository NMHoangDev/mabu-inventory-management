...
class _ZcaWorker:
    ...
    async def start(self) -> None:
        ...
        # Increase internal StreamReader buffer limit (default 64KB is too small for large group lists)
        if self._proc.stdout:
            self._proc.stdout._limit = 20 * 1024 * 1024  # 20MB
        if self._proc.stderr:
            self._proc.stderr._limit = 20 * 1024 * 1024  # 20MB
