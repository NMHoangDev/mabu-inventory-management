...
# Các lệnh phức tạp cần listener riêng / long-running — không dùng được qua persistent server
# "first-time-sync": chạy rất lâu (sync groups + friends + messages), pool sẽ timeout
