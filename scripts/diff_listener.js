...
const file = 'linkedin_group_crawler/app/modules/all_platform/zalo/services/zca_persistent_listener.py';

console.log(`\n=============================================================`);
console.log(`DIFF FOR LISTENER: ${file}`);
console.log(`=============================================================`);
...
try {
  ...
  console.log(output.slice(0, 5000)); // limit output to avoid truncation
} catch (e) {
  if (e.stdout) {
