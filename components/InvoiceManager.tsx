            ...
            <aside className="overflow-hidden">
                ...
                {queuedFiles.map((info) => {
                  ...
                  <div key={info.signature} className="flex items-start gap-3 border-b border-slate-200 px-5 py-3">
                    ...
                    <button
                      ...
                      onClick={() => {
                        setFiles((current) => current.filter((file) => fileSignature(file) !== info.signature));
                        setFileHashes((current) => {
                          const next = { ...current };
              ...
              <div className="border-t border-slate-200 p-5">
                ...
                >
                  ...
                  {queuedStats.duplicateCount > 0
                    ? `Scan ${queuedStats.newCount + queuedStats.restoreCount + queuedStats.retryCount} file · bỏ qua ${queuedStats.duplicateCount} trùng`
