            ...
            >
              ...
              >
                ...
                <div className="min-w-0 flex-1 flex flex-col">
                  ...
                  <div className="zalo-chat-item-row3 flex items-center justify-between gap-1">
                    <div
                    ...
                    >
                      {conv.latest_content ? (
                        ...
                        <span className="italic text-slate-400 text-[10px]">
                          {conv.has_messages === false || conv.sync_status === "no_messages" 
                            ? "Chưa có tin nhắn" 
                            : "Chưa đồng bộ"}
                        </span>
                      )}
