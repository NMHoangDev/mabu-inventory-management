...
import { AlertTriangle, Loader2, MessageSquare, MessageSquarePlus, RefreshCcw, Search, Send, UserPlus } from "lucide-react";
import Link from "next/link";
import { useEffect, useMemo, useState } from "react";
import { ZaloConversation, ZaloStrangerUser, zaloApi } from "@/lib/zalo-api";
      ...
      <div className="shrink-0 border-b border-slate-200 p-3">
        ...
        {stranger ? (
          <button
            ...
            className="mt-2 flex w-full items-center gap-2.5 rounded-lg border border-border bg-card px-3 py-2.5 text-left shadow-sm transition hover:bg-muted disabled:opacity-60"
          >
            <ConversationAvatar avatarUrl={stranger.avatar} label={stranger.display_name} className="h-9 w-9 text-sm" />
            ...
            <span className="inline-flex shrink-0 items-center gap-1 rounded-md bg-primary px-2 py-1 text-xs font-semibold text-primary-foreground">
